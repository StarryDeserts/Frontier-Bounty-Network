...
if (typeof console !== 'undefined') {
  if (FRONTEND_CONFIG_DIAGNOSTICS.isValid && FRONTEND_CONFIG) {
    ...
    console.error(
      ...
      formatFrontendConfigDiagnostics(FRONTEND_CONFIG_DIAGNOSTICS),
      FRONTEND_CONFIG_DIAGNOSTICS.raw,
    );
  }
}
...
export const INDEXER_HEALTH_TIMEOUT_MS =
  FRONTEND_CONFIG?.indexerHealthTimeoutMs ?? 1800;
